 ...
 * @since: 2019-10-18 11:18:07
 * @LastAuthor: lizlong
 * @lastTime: 2019-10-18 14:36:58
 -->
<template>
	<div>login</div>
</template>
...
export default {
	...
	created() {
			...
			define(function() {
				...
				impl.isMobileFallback = function(userAgent) {
					return (
						...
						impl.detectMobileBrowsers.shortPattern.test(
				...
				impl.isTabletFallback = function(userAgent) {
					return impl.detectMobileBrowsers.tabletPattern.test(
						userAgent
					);
				};
				...
				impl.prepareDetectionCache = function(
					...
					phone = impl.findMatch(
						impl.mobileDetectRules.phones,
						userAgent
					);
					if (phone) {
				...
				impl.mobileGrade = function(t) {
					...
					if (
						...
						(t.is("BlackBerry") &&
							t.version("BlackBerry") >= 6.0) ||
						// Blackberry Playbook (1.0-2.0) - Tested on PlayBook
						t.match("Playbook.*Tablet") ||
						// Palm WebOS (1.4-2.0) - Tested on the Palm Pixi (1.4), Pre (1.4), Pre 2 (2.0)
						(t.version("webOS") >= 1.4 &&
							t.match("Palm|Pre|Pixi")) ||
		...
		console.log("客户端平台版本号:" + version);

		var md = new MobileDetect(navigator.userAgent);
		// 品牌
		console.log("手机品牌:" + md.mobile());
		...
		console.log("当前系统语言:" + navigator.language);

		var networkStr = device_type.match(/NetType\/\w+/)
			? device_type.match(/NetType\/\w+/)[0]
			: "NetType/other";
		...
		console.log("判断是不是手机:" + is_telephone);
	}
};
</script>